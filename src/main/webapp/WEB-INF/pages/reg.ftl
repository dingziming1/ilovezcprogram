...
<div class="container" style="margin-top: -80px">
    ...
    <div class="form-signin" role="form" style="margin:50px auto">
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" id="reaname" placeholder="请输入姓名" style="margin-top:10px;">
            <span class="glyphicon glyphicon-user form-control-feedback"
                  style="font-size: 20px;margin-right: -5px;margin-top: 6px"></span>
        </div>
        <div class="form-group has-success has-feedback">
        ...
        <div class="form-group has-success has-feedback">
            ...
            <span class="glyphicon glyphicon glyphicon-user form-control-feedback"
                  style="font-size: 20px;margin-right: -5px;margin-top: 6px"></span>
        </div>
        <div class="form-group has-success has-feedback">
